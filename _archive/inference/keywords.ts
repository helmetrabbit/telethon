...
// ── Humor / Meme / Shitpost detection ────────────────
// Users who self-identify as "shitposters" or use excessive meme language
// are often trolls or community members joking about high titles ("CEO of Vibes").
// Detecting these allows us to penalize professional role claims.

export const MEME_CONTENT_PATTERNS: RegExp[] = [
  /\b(shit\s*post(?:ing|er)?|meme\s*lord|wen\s*binance|wen\s*lambo|ser\b)/i,
  /\b(ceo\s+of\s+(?:vibes|memes|nothing))\b/i,
];
